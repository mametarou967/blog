...
- FeliCa
- SoftwareSerial
description: SpresenseでFeliCaを読み取る
---


## 概要

FeliCaカードを近づけて読み取れると、SpresenseのLEDが光るものを作ります。
nanacoなどを近づけると反応すると思います。
SpresenseはUART2としてハードウェアシリアルがありますが、今回はソフトウェアシリアルを試してみます。

## 結線

|RC-S620Sのピン|Spresenseのピン|
|:---:|:---:|
|GND|GND|
|Reserve|-|
|GND|GND|
...
nanacoなどをRSC-620Sに近づけるとLEDが光ります。